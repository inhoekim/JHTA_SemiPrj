...
<h3>관리자 회원정보수정</h3>
<form onsubmit="return gaipSubmit();" id="gaip_chk" method="post" action="<%=request.getContextPath() %>/Admin/update">
<input placeholder="아이디 입력" type="text"  id="hlogin_id" name="hlogin_id"  value="${vo.hlogin_id }" readonly="readonly"  maxlength="12" size="20"  style="width: 200pt; height:25pt; border-radius: 5px;background-color: #D2D2D2;">
	<br>
	 ...
	 <input placeholder="새로운비밀번호 4자리이상" type="password" name="pwd" id="hlogin_pass" maxlength="12" size="20" style="width: 200pt; height:25pt; border-radius: 5px;"><br>
	...
	<input  placeholder="주민등록번호 입력" type="text" id="jnum" value="${vo.jnum }"   name="jnum" maxlength="13" style="width: 200pt; height:25pt; border-radius: 5px;"><br>
