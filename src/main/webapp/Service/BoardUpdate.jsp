...
<form action="${pageContext.request.contextPath }/service/board/update" method="post" name="inform">
		...
		*비밀번호는 필수 입력 사항입니다.</p>
		<input type="button" value="수정하기" onclick="Update()" style="width:80px;height:30px;color:#ff6666;background-color:white;border-radius:4px;border-color:#ff6666;font-size:20px;">
		<input type="button" value="목록으로 돌아가기" onclick="ReturnList()" style="width:80px;height:30px;color:white;background-color:#ff6666;border-radius:4px;border-color:#ff6666;font-size:20px;">
