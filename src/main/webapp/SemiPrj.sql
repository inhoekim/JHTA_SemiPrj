...
CREATE SEQUENCE SEQ_ROOM INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_RESERVE INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_PAYMENT INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_SERVICE INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_COMMENTS INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_FILES INCREMENT BY 1 START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_RECOMMEND INCREMENT BY 1 START WITH 1 NOCACHE;
