...
<div class="img_change1">  
	...
	<div class="container1">   
		<ul class="slider-container1 simple-list1" id="slider1">       
			...
			<div>
				<div class="content1" style="width:310px; height: 400px;display:inline-block;vertical-align: top;">  
	   ...
	   <li class="slide1">
	   <div>
		<div class="content1" style="width:310px; height:400px;display:inline-block;">
			<a href="" class="swiper-slide1"><!-- 해당 룸 예약창으로 -->
